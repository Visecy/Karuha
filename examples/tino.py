...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--quotes", default=_quotes_path, type=Path, help="file with messages for the chatbot to use, one message per line"
    )
    ...
    karuha.init_config(
        ...
        bots=[
            karuha.BotConfig(  # type: ignore
                name="chatbot", scheme=login_scheme, secret=login_secret
            )
        ],
    )
