...
def on_command(
    func_or_name: Union[str, Callable[P, R], None] = None, /, *, collection: Optional[CommandCollection] = None, **kwds: Any
...
def on_rule(
    rule: Optional[BaseRule] = None, *, once: bool = False, weights: float = 1.5, **kwds: Any
) -> Callable[[Callable[P, R]], _RuleDispatcherWrapper[P, R]]:
